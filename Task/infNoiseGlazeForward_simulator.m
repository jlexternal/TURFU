...
%   Name:   infNoiseGlazeForward_simulator.m
% Author:   Jun Seok Lee
%   Date:   April 2019
%   Type:   Function
%   Note:   For the TURFU experiment

function responses = infNoiseGlazeForward_simulator(haz, sigm, seqllrs, nsamples)
...
%   nsamples:= [array{integer)] number of samples on a given trial
    ...
    for itrial = 1:n_trials
        ...
        % Forward model
        beliefs(itrial) = seqllrs(itrial) + psi(beliefs(itrial)); %L_{n+1} with
